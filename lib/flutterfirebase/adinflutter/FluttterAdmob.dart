...
class FlutterAdmob extends StatelessWidget {
  const FlutterAdmob({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      debugShowCheckedModeBanner: false,
      home: Homepageflutteradmob(),
    );
  }
}

class Homepageflutteradmob extends StatefulWidget {
  const Homepageflutteradmob({Key? key}) : super(key: key);

  @override
  State<Homepageflutteradmob> createState() => _HomepageflutteradmobState();
}

class _HomepageflutteradmobState extends State<Homepageflutteradmob> {
